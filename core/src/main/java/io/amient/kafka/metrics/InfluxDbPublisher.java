...
public class InfluxDbPublisher implements MeasurementPublisher {
    ...
    static final String COFNIG_INFLUXDB_USERNAME = System.getenv("INFLUXDB_USERNAME");
    static final String COFNIG_INFLUXDB_PASSWORD = System.getenv("INFLUXDB_PASSWORD");
